...
function UserCard() {
  return (
    <div className="mb-5 cursor-pointer py-4 px-6 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex justify-between items-center hover:shadow-lg transition-shadow duration-300">
        <div>
